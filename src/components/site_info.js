...
export const summary_dic = {
    ...
    'our experts': 'A page to showcase the people that make up Rhema. This establishes that crucial human connection. When users see faces and read stories they will become more invested in your brand. Using this space to express gratitude toward your team and showcase individual talents can help promote a sense of unity and strength to your operation, which will in turn increase client confidence.',
